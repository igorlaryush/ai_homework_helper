...
const defaultComponents = {
  h1: ({ className, ...props }) => (
    <h1 className={cn('aui-md-h1 scroll-m-20 text-4xl font-extrabold tracking-tight', className)} {...props} />
  ),
  h2: ({ className, ...props }) => (
    <h2 className={cn('aui-md-h2 scroll-m-20 text-3xl font-semibold tracking-tight', className)} {...props} />
  ),
  h3: ({ className, ...props }) => (
    <h3 className={cn('aui-md-h3 scroll-m-20 text-2xl font-semibold tracking-tight', className)} {...props} />
  ),
  h4: ({ className, ...props }) => (
    <h4 className={cn('aui-md-h4 scroll-m-20 text-xl font-semibold tracking-tight', className)} {...props} />
  ),
  h5: ({ className, ...props }) => <h5 className={cn('aui-md-h5 text-lg font-semibold', className)} {...props} />,
  h6: ({ className, ...props }) => <h6 className={cn('aui-md-h6 font-semibold', className)} {...props} />,
  p: ({ className, ...props }) => <p className={cn('aui-md-p leading-7', className)} {...props} />,
  a: ({ className, ...props }) => (
  ...
  ul: ({ className, ...props }) => <ul className={cn('aui-md-ul ml-6 list-disc', className)} {...props} />,
  ol: ({ className, ...props }) => <ol className={cn('aui-md-ol ml-6 list-decimal', className)} {...props} />,
  hr: ({ className, ...props }) => <hr className={cn('aui-md-hr border-b', className)} {...props} />,
  table: ({ className, ...props }) => (
    <table
      className={cn('aui-md-table w-full border-separate border-spacing-0 overflow-y-auto', className)}
      {...props}
    />
  ),
  th: ({ className, ...props }) => (
  ...
  code: function Code({
    ...
    return (
      <code className={cn('aui-md-inline-code bg-muted rounded border font-semibold', className)} {...props}>
        {children}
      </code>
    );
  },
